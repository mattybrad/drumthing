...
AudioConnection          patchCord1(pink1, 0, mixer1, 0);
...
AudioConnection          patchCord5(filter2, 1, envelope2, 0);
AudioConnection          patchCord6(filter3, 2, envelope3, 0);
AudioConnection          patchCord7(filter1, 0, envelope1, 0);
AudioConnection          patchCord8(envelope2, 0, mixer2, 1);
AudioConnection          patchCord9(envelope3, 0, mixer2, 2);
